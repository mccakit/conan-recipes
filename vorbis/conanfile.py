...
class vorbis(ConanFile):
    ...
    def source(self):
        subprocess.run(
            f'bash -c "git clone --recurse-submodules --shallow-submodules --depth 1 git@github.com:xiph/vorbis.git -b {self.version}"',
            shell=True,
            check=True,
        )
    ...
    def package_info(self):
        self.cpp_info.libs = ["vorbis", "vorbisenc", "vorbisfile"]
